...
<h3>FORMULÁRIO DE ATUALIZAÇÃO DE CONFIGURAÇÕES DO GRUPO</h3>
...
<div class="container">
  <form action="?#ancoraResp" method="POST">  
    ...
    <label for="fname">Ação a aplicar (apply)</label>
    <input type="text" id="apply" name="apply" value="unlocked" placeholder="Informe a ação a aplicar">
    announcement: definir que apenas administradores mandem mensagem.
	<br>not_announcement: permitir que todos os participantes enviem mensagem.
	<br>unlocked: permitir que todos participantes possam editar dados do grupo.
	<br>locked: apenas administradores podem editar dados do grupo.
    <br><br>
