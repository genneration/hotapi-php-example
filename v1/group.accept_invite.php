...
<h3>FORMULÁRIO DE ACEITAR CONVITE DE GRUPO COM CÓDIGO DO GRUPO</h3>

<div class="container">
  <form action="?#ancoraResp" method="POST">     
    <label for="fname">Código do convite a entrar no grupo</label>
    <input type="text" id="invite" name="invite" value="" placeholder="Informe o código do contive">    
