...
<h3>FORMULÁRIO DE ALTERAÇÃO DE DESCRIÇÃO DO GRUPO</h3>

<div class="container">
  <form action="?#ancoraResp" method="POST">  
    <label for="fname">Nova descrição do grupo</label>
    <input type="text" id="description" name="description" value="" placeholder="Informe a nova descrição para o grupo">
