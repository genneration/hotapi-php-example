...
<h3>FORMULÁRIO DE ENVIO DE MENSAGEM COM DOCUMENTO</h3>
...
<div class="container">
  <form action="?#ancoraResp" method="POST" enctype="multipart/form-data">  
    ...
    <div>
    Nome: <input type="text" style="width:30%;" id="document_name" name="document_name" value="" placeholder="Opcional">
    - URL: <input type="text" style="width:50%;" id="document_url" name="document_url" value="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf" placeholder="Enviar por uma URL">
    </div>
...
if($_POST["document_url"] != ""){
	$postParameter["document_name"] = $_POST["document_name"];
	$postParameter["document_url"] = $_POST["document_url"];
	
}else{//if($_POST["document_url"] != ""){

	//ADICIONAR O ARRAY ARQUIVO PARA MONTAGEM DO MASE64 PARA ENVIO..............................................
	if(isset($_FILES['document_upload'])){
		$postParameter["document_name"] = $_FILES['document_upload']['name'];
		$file_bin = file_get_contents($_FILES['document_upload']['tmp_name']);
		//verificar tipo de arquivo
		$finfo = new finfo(FILEINFO_MIME_TYPE);
		$file_type = $finfo->buffer($file_bin);//pega informação MIME
		$postParameter["document_base64"] = "data:".$file_type.";base64,".base64_encode($file_bin);
	}//if(isset($_FILES['document_url'])){
