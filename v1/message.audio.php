...
<div class="container">
  <form action="?#ancoraResp" method="POST" enctype="multipart/form-data">  
    ...
    - URL: <input type="text" style="width:50%;" id="audio_url" name="audio_url" value="https://upload.wikimedia.org/wikipedia/en/a/ab/03_Maroon_5_Daylight.ogg" placeholder="Enviar por uma URL">
    </div>
