...
<h3>FORMULÁRIO DE ALTERAÇÃO DE NOME DE GRUPO</h3>

<div class="container">
  <form action="?#ancoraResp" method="POST">  
    <label for="fname">Novo nome do grupo</label>
    <input type="text" id="name" name="name" value="" placeholder="Informe o novo nome para o grupo">
