...
<h3>FORMULÁRIO DE ATUALIZAÇÃO DE PARTICIPANTES DE GRUPO</h3>
...
<div class="container">
  <form action="?#ancoraResp" method="POST">  
    ...
    <input type="text" id="apply" name="apply" value="add" placeholder="Informe a ação a aplicar">
    add: adicionar participantes.
	<br>promote: promover à administrador.
	<br>demote: remover privilégio de administrador.
	<br>remove: remover participantes do grupo.
    <br><br>
    <label for="fname">Número do participante para ação</label>
    <input type="text" id="participant" name="participant" value="" placeholder="Informe número do participante">
