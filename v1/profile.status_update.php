...
<div class="container">
  <form action="?#ancoraResp" method="POST">  
    <label for="fname">Informar um nome para alteração</label>
    <input type="text" id="name" name="name" value="" placeholder="Informe um nome">
    
    <hr />
    *Pode alterar somente o nome, somente o status ou os dois ao mesmo tempo.
    <hr />
    
    <label for="fname">Informe a legenda para o status do seu perfil</label>
    <input type="text" id="status" name="status" value="" placeholder="Informe o status">
...
$postParameter = array(//VARIÁVEIS POST DA REQUISICAO
	...
	"name"=>$_POST["name"],//aceita enviar só esse ou so o de baixo
	"status"=>$_POST["status"]//aceita enviar só esse ou so o de cima
);
